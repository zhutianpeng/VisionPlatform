...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/common/jquery-3.3.1.min.js"></script>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/global.scss">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/index.css">
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/common/stomp.js"></script>
    <script src="${pageContext.request.contextPath}/js/components/DataBox.js"></script><!-- 引入DataBox组件 -->
    <script src="${pageContext.request.contextPath}/js/components/Common.js"></script><!-- 引入组件 -->
    <script src="${pageContext.request.contextPath}/js/components/Exercise.js"></script><!-- 用于健身指导功能的全部组件 -->
    <script src="${pageContext.request.contextPath}/js/components/Dance.js"></script><!-- 用于动画舞蹈的全部组件 -->
...
<div class="data-page" id="app">
    <el-menu style="border-bottom: none" :default-active="'1'" class="el-menu-demo" mode="horizontal" background-color="black" text-color="#fff" active-text-color="#ffd04b">
