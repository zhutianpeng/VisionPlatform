...
<body>
<div class="data-page" id="exercise2">
    ...
    <div class="data-content">
        ...
        <div class="data-main">
            <div class="main-left">
                <data-box :title="'动作选择区'" :dheight="800">
                </data-box>
            </div>
...
<script>
    ...
    var exercise2D = new Vue({
        ...
        mounted: function(){
            this.gameInstance = UnityLoader.instantiate("gameContainer", "${pageContext.request.contextPath}/webGL/Loader/Receiver2Dv5.json", {onProgress: UnityProgress});
